...
Declare.w               GetExprResultType( *x.stTree )   
...
EndProcedure
   ...
   Procedure.w          GetExprResultType( *x.stTree )
      Protected         n
      ...
      Select *x\NodeType
         ...
         Case #ljNEGATE
            ...
            ProcedureReturn GetExprResultType(*x\left)
