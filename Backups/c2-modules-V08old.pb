   ...
   Procedure            CodeGenerator( *x.stTree, *link.stTree = 0 )
      ...
      Select *x\NodeType
         ...
         Case #ljLESS, #ljGREATER, #ljLESSEQUAL, #ljGreaterEqual, #ljEQUAL, #ljNotEqual,
            ...
            ; Also check right operand - if either is float, use float operation
            If opType <> #C2FLAG_FLOAT  ; Only check if not already float
               ...
               ElseIf *x\right\NodeType = #ljFLOAT
                  opType = #C2FLAG_FLOAT
               ElseIf *x\right\NodeType = #ljSTRING And opType <> #C2FLAG_STR
                  opType = #C2FLAG_STR
               EndIf
            EndIf
