# Pointer Implementation Design for CX Language
Version: 1.0
Date: 2025

## Overview
This document outlines the design for implementing pointers in the CX language, including pointer types, operations, arrays of pointers, and function pointers.
...
Since CX uses a slot-based VM (gVar array), pointers are represented as **slot indices** rather than memory addresses:
