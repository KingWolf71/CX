...
c2tokens:
   ...
   Data.s   "BREAK"
   Data.s   "CONTINUE"
   Data.s   "FOREACH"      ; V1.034.6: foreach loop keyword
   Data.s   "JZ"
   Data.s   "JMP"
   Data.s   "NEG"
   Data.i   #ljFLOATNEG, 0
   ...
   Data.s   "LLMOVS"
   Data.s   "LLMOVF"
   Data.s   "LLPMOV"      ; LL PMOV: pointer variant
   ...
   Data.s   "STOSTRUCT"
   Data.s   "LSTOSTRU"    ; V1.031.32: Local variant of STORE_STRUCT
   ...
   ; V1.034.6: ForEach opcodes (scoped iterator)
   Data.s   "FE_LSTI"
   Data.s   "FE_LSTN"
   Data.s   "FE_MAPI"
   Data.s   "FE_MAPN"
   ...
   ; V1.027.0: Type-Specialized Pointer Opcodes
   Data.s   "PRTPTR_I"
   Data.s   "PRTPTR_F"
   Data.s   "PRTPTR_S"
   Data.s   "PRTPTR_AI"
