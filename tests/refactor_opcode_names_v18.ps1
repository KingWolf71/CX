...
$incFile = 'd:\OneDrive\WIP\Sources\Intense.2020\lj2\c2-inc-v18.pbi'
$opcodeProc = Get-Content 'd:\OneDrive\WIP\Sources\Intense.2020\lj2\opcode_names_proc_v18.txt' -Raw
